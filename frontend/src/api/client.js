...
export const api = {
  ...
  retificacaoComparar:     (body) => request('/api/v1/fiscal/retificacao/comparar', { method: 'POST', body }),
  retificacaoValidarLayout:(body) => request('/api/v1/fiscal/retificacao/validar-layout', { method: 'POST', body }),
  retificacaoGerar:        (body) => request('/api/v1/fiscal/retificacao/nota-correcao', { method: 'POST', body }),
  perDcompTipos:  () => request('/api/v1/fiscal/per-dcomp/tipos'),
  perDcompGerar:  (body) => request('/api/v1/fiscal/per-dcomp/gerar', { method: 'POST', body }),
  perDcompValidar:(body) => request('/api/v1/fiscal/per-dcomp/validar', { method: 'POST', body }),
  transmissaoCircuit: () => request('/api/v1/fiscal/transmissao/circuit'),
  transmissaoEnviar:  (body) => request('/api/v1/fiscal/transmissao/enviar', { method: 'POST', body }),
  transmissaoStatus:  (id) => request(`/api/v1/fiscal/transmissao/status/${id}`),
